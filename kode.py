...
PORT_NUMBER = 1234 # Maybe set this to 1234 / So, complete address would be: http://127.0.0.1:1234
...
class MyHandler(BaseHTTPRequestHandler):
	...
	def do_GET(s):
		...
		if path.find("/") != -1 and len(path) == 1:
			...
			s.wfile.write(bytes('<label for="cwidth">Set Length:</label><br>', 'utf-8'))
			s.wfile.write(bytes('<input type="text" id="cwidth" name="cwidth" value="100"><br><br>', 'utf-8'))
